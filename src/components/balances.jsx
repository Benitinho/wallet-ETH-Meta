...
function Balance() {
  ...
  async function sendTransaction() {
    const toAddress = '0xdf5409EFaCa78ac58628A5a353ed7A0b95C61475'; // replace with recipient's address
    const value = window.web3.utils.toWei('0.1', 'ether'); // replace with amount to send
